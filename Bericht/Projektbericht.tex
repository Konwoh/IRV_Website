...
Datenpunkt, gewährleistet. Der Scatterplot ist effektiv, weil er ohne großen Aufwand sehr viele und nützliche Informationen darstellen kann. Der Scatterplot ist angemessen, da
er eine der trivialsten Möglichkeiten ist, um zwei numerische Attribute aufeinander darzustellen. Daten-Ausreißer sind bei dieser Visualisierungstechnik ebenfalls leicht zu
identifizieren, da diese sich erheblich von Punktelinien oder Punktewolken entfernen und deswegen sehr schnell ins Auge fallen. 
werden.\\

\noindent Die Scatterplot-Technik ist für den zu untersuchenden Datensatz perfekt geeignet, weil es für die Beantwortung der Fragestellungen immer eine Betrachtung von
zwei Variablen in verschiedensten Kombinationen notwendig ist. Des Weiteren kann durch die eindeutige Zuweisung der Datenpunkte zu ihren Datenreihen, zusätzliche Analysen bzgl.
des gewählten Datenpunktes stattfinden, die gegebnfalls zu weiteren Erkenntnissen führen. Zudem sind kaum ebenbürtige Alternativen zum Scatterplot verfügbar. So sagten
unteranderem Friendly und Denis in ihrem Werk über Scatterplots: \begin{quote}"Indeed, among all the forms of statistical graphics, the humble scatterplot may be considered
	the most versatile, polymorphic, and generally useful invention in the entire history of statistical graphics."\cite[103]{Friendly2005}\end{quote}
Einzig allein der Quantil-Quantil-Plot kann in Erwägung gezogen werden. Diese Technik liefert allerdings keinen wirklichen Beitrag zur Beantwortung der Forschungsfragen, da hier
lediglich die Verteilungen der beiden numerischen Attribute verglichen werden, aber keine Informatione zu möglichen Korrelationen daraus resultieren.
